...
class _ProductDetailState extends State<ProductDetail> {
  ...
  void messageBtn() async {
    //  // : after getting into the chatscreen load messages from the conversationId on initstate
    //  // : everytime you load messages clear old messages that were there before them
